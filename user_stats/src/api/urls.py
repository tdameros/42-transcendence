...
from api.views.user_graph import UserGraphEloView, UserGraphWinRateView, UserGraphMatchesPlayedView
...
urlpatterns = [
    ...
    path('user/<int:user_id>/graph/matches_played/', UserGraphMatchesPlayedView.as_view(), name='user_graph_matches_played'),
