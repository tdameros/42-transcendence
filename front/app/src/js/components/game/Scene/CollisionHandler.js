...
export class CollisionHandler {
  ...
  updateBallPositionAndMovement(ball, timeDelta, match, ballRadius) {
    ...
    while (travel !== null) {
      const closestObjectHit = this._getClosestObjectHit(
          travel, this.physicalPaddle, ballRadius,
      );
